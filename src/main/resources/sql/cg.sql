...
insert  into `warehouse_order`(`id`,`order_num`,`staff_id`,`staff_name`,`product_id`,`customer_id`,`order_date`,`delivery_quantity_total`,`delivery_quantity_need`,`unit_price`,`total_price`,`order_status`,`delivery_date`,`warehouse_manager_id`,`warehouse_manager_name`) values (1,'XS201811050001',1,'郑昌萌',1,5,1541376000000,200.00,200.00,10.00,2000.00,'未配送',1541894400000,7,'刘广源'),(2,'XS201811060001',1,'郑昌萌',2,6,1541462400000,11.21,11.21,11.21,125.65,'未配送',1542326400000,6,'詹茁'),(3,'XS201811070001',1,'郑昌萌',1,7,1541548800000,1099.00,1099.00,123.00,135177.00,'未配送',1543536000000,7,'刘广源'),(4,'XS201811070002',1,'郑昌萌',1,8,1541548800000,10.00,10.00,1000.00,10000.00,'未配送',1542844800000,14,'仓库管理员1'),(5,'XS201811010001',1,'郑昌萌',2,9,1541030400000,1.24,1.24,12.33,15.23,'未配送',1542240000000,24,'nicka'),(6,'XS201811070003',1,'郑昌萌',3,10,1541548800000,1.12,1.12,1.23,1.38,'未配送',1541721600000,7,'刘广源');
