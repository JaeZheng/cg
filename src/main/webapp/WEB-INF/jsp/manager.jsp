        ...
        <div class="col-md-11">
            <div class="" id="feature-display">
                <div class="tab-content">
                    ...
                    <!--<div class="tab-pane" id="statistics-query">-->
                    <!--&lt;!&ndash; 原料采购统计 &ndash;&gt;-->
                    ...
                    <!--data-url="FactoryStatistics/outputs" data-div=".factory-out-storage-total-weight-statistics-table"-->
                    ...
                    <!--<label for="fostws-end-date">终止时间 </label><input type="text" name="end-time" id="fostws-end-date"-->
                    <!--value="">-->
                    ...
                    <!--<label for="otas-end-date">终止时间 </label><input type="text" name="end-time" id="otas-end-date"-->
                    <!--value="">-->
                    ...
                    <div class="tab-pane" id="blow-on">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="blowon-record-modal row">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div>
                                                                ...
                                                                <button class="btn-clear-record" type="button">清空
                                                                </button>
                                                            </div>
                                                            <div class="table-content">
                                                            ...
                                                            <div class="table-content">
                                                                <table class=" table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td data-read><input class="input-in-td"
                                                                                             type="text"
                                                                                             id="consume-sum"></td>
                                                                        <td data-read><input class="input-in-td"
                                                                                             type="text"
                                                                        ...
                                                                        <td data-produce><input
                                                                                class="row-append input-in-td"
                                                                                type="text" id="blank-produce">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <!-- 胚料登记模态框结束 -->
                                            <div class="col-md-3">
                                                <button class="btn btn-primary" id="bor-record-button" type="button">
                                                    开炉查询
                                                </button>
                                            </div>
                                            <div class="col-md-3">
                                                <button class="btn btn-primary" id="lr-record-button" type="button">
                                                    损耗比查询
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div class="panel panel-default block-shadow blowon-record-table table-data"
                            ...
                            <div class="panel-body panel-body-border">
                                ...
                                <label for="bor-end-date">终止时间 </label><input type="text" name="end-time"
                                                                              id="bor-end-date"
                                                                              value="">
