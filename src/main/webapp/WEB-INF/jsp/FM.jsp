        ...
        <div class="container-fluid">
            ...
            <div class="fl">
                <ul class="nav navbar-nav">
                    ...
                    <li class="role-navbar-na active" id="factory-navbar-nav"><a href="#">工厂</a></li>
    ...
    <div class="col-md-1">
        <nav class="block-display block-shadow" id="feature-nav">
            <ul class="nav nav-tabs nav-stacked nav-pills nav-click" id="nav-tabs">
                ...
                <!--</li>-->
                <li class="factory-navtabs"><a name="materialPurchase" href="#material-purchase"
                ...
                <li class="factory-navtabs"><a name="outStorageRecord" href="#out-storage-record"
                                                                      role="tab" data-toggle="tab">出库记录</a></li>
                <li class="factory-navtabs"><a name="factoryInventory" href="#factory-inventory"
